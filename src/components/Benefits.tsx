...
// --- Sub-componente para Contadores Animados ---
...
const detailedBenefits = [
    { category: "Operacional", icon: Zap, benefits: ["Automatización de procesos repetitivos", "Reducción de errores humanos", "Optimización de recursos", "Escalabilidad instantánea", "Integración con sistemas existentes"] },
    { category: "Financiero", icon: BarChart3, benefits: ["ROI positivo en 6 meses", "Reducción de costos operativos", "Incremento en ingresos", "Optimización de inversión tecnológica", "Modelo de pricing flexible"] },
    { category: "Estratégico", icon: Target, benefits: ["Ventaja competitiva sostenible", "Insights de negocio en tiempo real", "Toma de decisiones basada en datos", "Adaptabilidad a cambios del mercado", "Innovación continua"] },
    { category: "Experiencia", icon: Star, benefits: ["Experiencia omnicanal unificada", "Personalización a escala", "Respuesta inmediata 24/7", "Resolución proactiva de problemas", "Fidelización de clientes"] }
];

const whyChooseUs = [
    { icon: Lightbulb, title: "Innovación Constante", description: "Siempre a la vanguardia de las últimas tecnologías y tendencias del mercado." },
    { icon: Users, title: "Equipo Experto y Certificado", description: "Profesionales con años de experiencia real en la industria y sus desafíos." },
    { icon: Shield, title: "Soporte y Acompañamiento", description: "Somos un socio estratégico que garantiza el éxito de tu implementación." }
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2 variants={itemVariants} className="text-4xl lg:text-5xl font-bold text-white tracking-tight mb-6">
            Valor que se <span className="text-cyan-400">Mide</span>, Confianza que se <span className="text-cyan-400">Gana</span>
          </motion.h2>
          <motion.p variants={itemVariants} className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Nuestras soluciones no solo optimizan procesos, sino que generan un impacto medible en las métricas clave de tu negocio.
          </motion.p>
        </motion.div>

        {/* --- Hub de Resultados con Contadores Animados --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mb-24">
          {mainBenefits.map((benefit) => (
            <div key={benefit.title} className="p-6 rounded-2xl bg-white/5 border border-white/10 text-center">
              ...
              <p className="text-gray-400 mt-2">{benefit.title}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mb-24">
          <h3 className="text-3xl font-bold text-white text-center mb-12">Un Impacto en Cada Área de tu Negocio</h3>
